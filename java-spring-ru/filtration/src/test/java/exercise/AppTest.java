...
public class AppTest {
    ...
    void testFilterByAllParameters() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(get("/users?firstName=nia&lastName=dd&email=wei&profession=Man&gender=Male"))
                .andReturn()
                .getResponse();
        ...
        User actualUser = actualUsers.get(0);
        assertThat(actualUsers.size()).isEqualTo(1);
        assertThat(actualUser.getFirstName()).isEqualTo("Alvinia");
        assertThat(actualUser.getLastName()).isEqualTo("Quiddihy");
        assertThat(actualUser.getEmail()).isEqualTo("aquiddihy2q@weibo.com");
        assertThat(actualUser.getProfession()).isEqualTo("Project Manager");
