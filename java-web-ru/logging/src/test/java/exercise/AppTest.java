...
class AppTest {
    ...
    // BEGIN
    @Test
    void testUserSignUp() throws IOException, ParseException {
        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost postRequest = new HttpPost(baseUrl + "/users/list");
        List<NameValuePair> params = new ArrayList<>();
        params.add(new BasicNameValuePair("firstName", "Daria"));
        params.add(new BasicNameValuePair("lastName", "Petrova"));
        params.add(new BasicNameValuePair("email", "daria@mail.ru"));
        postRequest.setEntity(new UrlEncodedFormEntity(params));
        CloseableHttpResponse response = client.execute(postRequest);
        assertThat(response.getCode()).isEqualTo(200);
        ...
        assertThat(response2.getCode()).isEqualTo(200);
        assertThat(content).contains("Daria Petrova");
    }

    @Test
    void testUserSignUpFirstNameIsEmpty() throws IOException, ParseException {
        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost postRequest = new HttpPost(baseUrl + "/users/list");
        List<NameValuePair> params = new ArrayList<>();
        params.add(new BasicNameValuePair("firstName", ""));
    ...
    @Test
    void testUserSignUpLastNameIsEmpty() throws IOException, ParseException {
        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost postRequest = new HttpPost(baseUrl + "/users/list");
        List<NameValuePair> params = new ArrayList<>();
        params.add(new BasicNameValuePair("firstName", "Daria"));
    ...
    @Test
    void testUserSignUpEmailIsEmpty() throws IOException, ParseException {
        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost postRequest = new HttpPost(baseUrl + "/users/list");
        List<NameValuePair> params = new ArrayList<>();
        params.add(new BasicNameValuePair("firstName", "Daria"));
        params.add(new BasicNameValuePair("lastName", "Ivanova"));
        ...
        assertThat(response2.getCode()).isEqualTo(200);
        assertThat(content).contains("Daria Ivanova");
    }
